...
//==============================================================================
void AudioStreamPluginPlaybackRenderer::prepareToPlay (double sampleRateIn, int maximumSamplesPerBlockIn, int numChannelsIn, juce::AudioProcessor::ProcessingPrecision, AlwaysNonRealtime alwaysNonRealtime)
{
    ...
    for (auto* playbackRegion : getPlaybackRegions())
        readers.createReader (playbackRegion);
}

void AudioStreamPluginPlaybackRenderer::releaseResources()
{
}

//==============================================================================
bool AudioStreamPluginPlaybackRenderer::processBlock (juce::AudioBuffer<float>& buffer,
